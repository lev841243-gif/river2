...
export const contacts = {
  ...
  /** Организация на Яндекс.Картах — карточка «Судоходная компания ДНО». */
  yandexMaps:
    'https://yandex.ru/maps/org/sudokhodnaya_kompaniya_dno/18284574311/?ll=30.320487%2C59.953202&z=16.6',
  /**
   * Отзывы — та же карточка «Судоходная компания ДНО», путь с `/reviews/`.
...
export const boats: Boat[] = [
  {
    ...
    dir: 'Картье',
    cover: 'cover.webp',
    photos: ['01.webp', '02.webp', '03.webp', '04.webp', '05.webp', '06.webp', '07.webp', '08.webp', '09.webp'],
    price: 8000,
    name: { ru: 'Картье', en: 'Cartier' },
    desc: {
      ru: 'Новинка нашего флота. Уютный катер для прогулки по рекам и каналам Петербурга. Подробные характеристики — по запросу.',
      en: 'A new addition to our fleet. A cosy boat for a cruise along the rivers and canals of St. Petersburg. Full specifications available on request.',
    },
    specs: null,
    amenities: {
      ru: [],
...
export const dict: Record<Lang, Dict> = {
  ru: {
    ...
    experiences: {
      ...
      items: [
        { title: 'Романтический вечер', caption: 'Только вы вдвоём', image: '/images/exp-romantic.webp', span: 'lg:col-span-2 lg:row-span-2', href: '/predlozhenie-ruki-na-katere' },
        { title: 'Белые ночи и развод мостов', caption: 'Город, который не спит', image: '/images/exp-white-nights.webp', span: 'lg:col-span-2', href: '/belye-nochi-razvod-mostov' },
        { title: 'День рождения', caption: 'Вечер, который запомнится', image: '/images/exp-birthday.webp', span: '', href: '/den-rozhdeniya-na-katere' },
        { title: 'Корпоратив', caption: 'Впечатлите каждого гостя', image: '/images/exp-corporate.webp', span: '', href: '/korporativ-na-katere' },
        { title: 'Фотосессия', caption: 'Золотой час на воде', image: '/images/exp-photo.webp', span: '', href: '/fotosessiya-na-katere' },
        { title: 'Семейная прогулка', caption: 'Вместе и без спешки', image: '/images/exp-family.webp', span: '', href: '/semeynaya-progulka-na-katere' },
    ...
    routes: {
      ...
      items: [
        { title: 'Императорские набережные', description: 'Пройдите мимо Зимнего дворца и Эрмитажа, когда фасады загораются золотом. Город открывается таким, каким его задумывали — с воды.', image: '/images/route-hermitage.webp', duration: '2 часа', price: 'от 24 000 ₽', stops: 'Дворцовая набережная · Эрмитаж · Стрелка' },
        { title: 'Белые ночи и разводные мосты', description: 'Ночная прогулка, выверенная под развод мостов. Стойте на палубе под небом, которое не темнеет, и смотрите, как Нева расступается перед вами.', image: '/images/route-bridges.webp', duration: '3 часа', price: 'от 36 000 ₽', stops: 'Дворцовый мост · Троицкий мост · Нева' },
        { title: 'Тайные каналы старого города', description: 'Скользите по тихим внутренним каналам к куполам Спаса на Крови — камерный, неспешный маршрут, который мало кто видел.', image: '/images/route-canals.webp', duration: '1,5 часа', price: 'от 18 000 ₽', stops: 'Мойка · Грибоедова · Фонтанка' },
      ],
    },
    expeditions: {
  ...
  en: {
    ...
    experiences: {
      ...
      items: [
        { title: 'Romantic Evening', caption: 'Just the two of you', image: '/images/exp-romantic.webp', span: 'lg:col-span-2 lg:row-span-2', href: '/en/marriage-proposal' },
        { title: 'White Nights & Bridge Opening', caption: 'The city that never sleeps', image: '/images/exp-white-nights.webp', span: 'lg:col-span-2', href: '/en/white-nights' },
        { title: 'Birthday Celebration', caption: 'A night to remember', image: '/images/exp-birthday.webp', span: '', href: '/en/birthday' },
        { title: 'Corporate Event', caption: 'Impress every guest', image: '/images/exp-corporate.webp', span: '', href: '/en/corporate-event' },
        { title: 'Photo Session', caption: 'Golden-hour on the water', image: '/images/exp-photo.webp', span: '', href: '/en/photo-session' },
        { title: 'Family Cruise', caption: 'Together, unhurried', image: '/images/exp-family.webp', span: '', href: '/en/family-cruise' },
    ...
    routes: {
      ...
      items: [
        { title: 'The Imperial Embankments', description: 'Drift past the Winter Palace and the Hermitage as the façades turn gold. The city reveals itself the way it was always meant to be seen — from the water.', image: '/images/route-hermitage.webp', duration: '2 hours', price: 'from ₽24,000', stops: 'Palace Embankment · Hermitage · Spit' },
        { title: 'White Nights & Open Bridges', description: 'A midnight cruise timed to the raising of the drawbridges. Stand on deck beneath a sky that never fully darkens and watch the Neva part before you.', image: '/images/route-bridges.webp', duration: '3 hours', price: 'from ₽36,000', stops: 'Palace Bridge · Trinity Bridge · Neva' },
        { title: 'Hidden Canals of the Old City', description: 'Slip through the quiet inner canals toward the domes of the Savior on Spilled Blood — an intimate, unhurried route few ever experience.', image: '/images/route-canals.webp', duration: '1.5 hours', price: 'from ₽18,000', stops: 'Moyka · Griboyedov · Fontanka' },
      ],
    },
    expeditions: {
