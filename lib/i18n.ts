...
export const dict: Record<Lang, Dict> = {
  ru: {
    ...
    experiences: {
      ...
      items: [
        { title: 'Романтический вечер', caption: 'Только вы вдвоём', image: '/images/exp-romantic.webp', span: 'lg:col-span-2 lg:row-span-2' },
        { title: 'Белые ночи и развод мостов', caption: 'Город, который не спит', image: '/images/exp-white-nights.webp', span: 'lg:col-span-2' },
        { title: 'День рождения', caption: 'Вечер, который запомнится', image: '/images/exp-birthday.webp', span: '' },
  ...
  en: {
    ...
    experiences: {
      ...
      items: [
        { title: 'Romantic Evening', caption: 'Just the two of you', image: '/images/exp-romantic.webp', span: 'lg:col-span-2 lg:row-span-2' },
        { title: 'White Nights & Bridge Opening', caption: 'The city that never sleeps', image: '/images/exp-white-nights.webp', span: 'lg:col-span-2' },
        { title: 'Birthday Celebration', caption: 'A night to remember', image: '/images/exp-birthday.webp', span: '' },
